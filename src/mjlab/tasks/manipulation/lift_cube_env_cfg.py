...
def make_lift_cube_env_cfg() -> ManagerBasedRlEnvCfg:
  ...
  actor_terms = {
    ...
    "ee_to_cube_right": ObservationTermCfg(
    ...
    "ee_to_cube_left": ObservationTermCfg(
      func=manipulation_mdp.ee_to_object_distance,
      params={
        "object_name": "cube",
        "asset_cfg": SceneEntityCfg("robot", site_names=()),  # Set per-robot.
  ...
  commands: dict[str, CommandTermCfg] = {
    "lift_height_right": LiftingCommandCfg(
      entity_name="cube",
    ...
    "lift_height_left": LiftingCommandCfg(
      entity_name="cube",
      resampling_time_range=(8.0, 12.0),
      debug_vis=True,
      difficulty="dynamic",
  ...
  rewards = {
    ...
    "lift_precise_right": RewardTermCfg(
    ...
    "lift_precise_left": RewardTermCfg(
      func=manipulation_mdp.bring_object_reward,
      weight=1.0,
      params={
        "command_name": "lift_height_left",
